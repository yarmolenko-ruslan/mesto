...
const closeModalProfileBtn = modalProfile.querySelector(selectors.closeModalProfileBtn);
const openModalProfileBtn = document.querySelector(selectors.openModalProfileBtn);
...
function createCard(element) {
    ...
    addListenerLikeCard(elementLike);
